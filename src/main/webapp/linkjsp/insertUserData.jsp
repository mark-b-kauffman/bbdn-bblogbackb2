...
<%
	...
	try {
		...
		if (contentIdString != null) {
                                ...
                                title = "2015.03.15.17.32 Hello with User Data!";
	
                                String description = "Link to a .jsp page in this B2 that shows you your user data.";

				String URL;

				String bbUid = ContextManagerFactory.getInstance().getContext().getVirtualInstallation().getBbUid();
                             
                                URL = "../../bb-SpringExtLinkDemo-" + bbUid + "/linkjsp/userdata.jsp?course_id=" + courseIdString + "&content_id=" + contentIdString;
				...
				extLink.setContentHandler( "resource/x-userdata" );
